...
We believe that Temporal_CONV provides a new reference for subsequent researchers to perform graph convolution for rs-fMRI as well as other time-series data. And Catroy_Pool has a strong generalizability and can be transferred to other medical research fields.
